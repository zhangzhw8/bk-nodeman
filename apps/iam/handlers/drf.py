...
class IAMPermission(permissions.BasePermission):
    def __init__(self, actions: List[ActionMeta], resources: Optional[List[Resource]] = None):
...
class InstanceActionPermission(IAMPermission):
    ...
    def __init__(
        self, actions: List[ActionMeta], resource_meta: ResourceMeta, instance_ids_getter: Optional[Callable] = None
    ):
